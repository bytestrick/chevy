...
public class Label extends JPanel {
    ...
    private void initLabel() {
        ...
        if (shadowSize < 0) shadow.setVisible(false);
    ...
    public void setAlignmentX(int alignmentX) {
        switch (alignmentX) {
            ...
            case RIGHT -> springLayout.putConstraint(SpringLayout.EAST, text, 0, SpringLayout.EAST, this);
            default -> springLayout.putConstraint(SpringLayout.WEST, text, 0, SpringLayout.WEST, this);
        }
    }
    ...
    public void setAlignmentY(int alignmentY) {
        switch (alignmentY) {
            case CENTER ->
                    springLayout.putConstraint(SpringLayout.VERTICAL_CENTER, text, 0, SpringLayout.VERTICAL_CENTER,
                            this);
            case BOTTOM -> springLayout.putConstraint(SpringLayout.SOUTH, text, 0, SpringLayout.SOUTH, this);
            default -> springLayout.putConstraint(SpringLayout.NORTH, text, 0, SpringLayout.NORTH, this);
        }
    }
    ...
    private Font loadFont(String fontPath) {
        try {
            ...
            Log.error("Caricamento del font fallito.");
        }
        return null;
    }
