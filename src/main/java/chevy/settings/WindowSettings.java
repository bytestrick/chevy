...
public class WindowSettings {
    ...
    public static final int ASPECT_RATIO_W = 4;
    public static final int ASPECT_RATIO_H = 3;
    ...
    public static int WINDOW_HEIGHT = MAX_WINDOW_WIDTH >= MAX_WINDOW_HEIGHT ? MAX_WINDOW_SIZE :
    ...
    public static int WINDOW_WIDTH = MAX_WINDOW_WIDTH <= MAX_WINDOW_HEIGHT ? MAX_WINDOW_SIZE :
