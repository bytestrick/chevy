...
public class Menu {
    ...
    private void applyStyle() {
        ...
        playerCycleNext.setIcon(new ImageIcon(Load.image("/icons/right-chevron.png").getScaledInstance(32, 32,
                Image.SCALE_SMOOTH)));
        playerCyclePrev.setIcon(new ImageIcon(Load.image("/icons/left-chevron.png").getScaledInstance(32, 32,
                Image.SCALE_SMOOTH)));
